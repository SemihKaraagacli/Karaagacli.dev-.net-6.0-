...
namespace CV.Controllers
{
    ...
    public class PanelProfilController : Controller
    {
        ...
        public IActionResult PanelProfil()
        {
            var values = db.panelProfils.ToList();
            return View(values);
        }
        [HttpGet]
        public IActionResult PP_Add()
        {
            return View();
        }
        [HttpPost]
        public IActionResult PP_Add(PanelProfil profil)
        {
            ...
            db.SaveChanges();
            return RedirectToAction("PanelProfil");
        }
        [HttpGet]
        public IActionResult PP_Get(int Id)
        {
            var pp_get = db.panelProfils.SingleOrDefault(x => x.Id == Id);
            return View(pp_get);
        }
        [HttpPost]
        public IActionResult PP_Update(PanelProfil p)
        {
